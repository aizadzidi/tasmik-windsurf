...
export default function EditReportModal({ report, onSave, onCancel, reportTypes, grades, surahs }: EditReportModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40">
      <form className="bg-white rounded-lg p-6 shadow-lg w-full max-w-md" onSubmit={handleSubmit}>
        ...
        <div className="flex justify-end gap-2 mt-4">
          <button type="button" className="px-4 py-2 bg-gray-200 rounded hover:bg-gray-300" onClick={onCancel}>Cancel</button>
